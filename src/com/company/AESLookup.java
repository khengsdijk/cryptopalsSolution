...
public class AESLookup {
    // java and bytes are pushing me over the line
    private static final int[] _forward = { 0x63, 0x7C, 0x77, 0x7B, 0xF2,
    ...
    public static byte forwardBox(byte b) { if (b < 0) return (byte)_forward[b + 256]; return (byte)_forward[b];}

    private static final int[] _inverse = { 0x52, 0x09, 0x6A, 0xD5, 0x30,
    ...
    public static byte inverseBox(byte b) { if (b < 0) return (byte)_inverse[b + 256]; return (byte)_inverse[b]; }

    private static final int[] _rcon = { 0x8d, 0x01, 0x02, 0x04, 0x08, 0x10,
    ...
    public static byte rcon(int b) { return (byte)_rcon[b]; }
